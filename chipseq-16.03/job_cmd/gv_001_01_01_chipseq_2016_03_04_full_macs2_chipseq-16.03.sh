#!/bin/bash
#$ -N gv_001_01_01_chipseq_2016_03_04_full_macs2_chipseq-16.03
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=20:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/gv_001_01_01_chipseq_2016_03_04_full_macs2_chipseq-16.03_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/gv_001_01_01_chipseq_2016_03_04_full_macs2_chipseq-16.03_$JOB_ID.err
#$ -j y
