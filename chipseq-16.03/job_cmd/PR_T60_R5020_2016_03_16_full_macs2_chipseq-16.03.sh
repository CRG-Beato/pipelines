#!/bin/bash
#$ -N PR_T60_R5020_2016_03_16_full_macs2_chipseq-16.03
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=20:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/PR_T60_R5020_2016_03_16_full_macs2_chipseq-16.03_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/PR_T60_R5020_2016_03_16_full_macs2_chipseq-16.03_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_03_16
pipeline_version=16.03
sample_id=PR_T60_R5020
data_type=chipseq
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.03/job_cmd/PR_T60_R5020_2016_03_16_full_macs2_chipseq-16.03.sh
time_start=$(date +"%s")
