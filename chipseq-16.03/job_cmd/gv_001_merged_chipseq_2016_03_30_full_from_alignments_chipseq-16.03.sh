#!/bin/bash
#$ -N gv_001_merged_chipseq_2016_03_30_full_from_alignments_chipseq-16.03
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=20:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/gv_001_merged_chipseq_2016_03_30_full_from_alignments_chipseq-16.03_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/gv_001_merged_chipseq_2016_03_30_full_from_alignments_chipseq-16.03_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2016_03_30
pipeline_version=16.03
sample_id=gv_001_merged_chipseq
data_type=chipseq
pipeline_name=chipseq
pipeline_version=16.03
pipeline_run_mode=full_from_alignments
io_mode=standard
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.03/job_cmd/gv_001_merged_chipseq_2016_03_30_full_from_alignments_chipseq-16.03.sh
time_start=$(date +"%s")
