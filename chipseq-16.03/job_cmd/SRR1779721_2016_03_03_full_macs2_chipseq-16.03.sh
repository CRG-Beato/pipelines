#!/bin/bash
#$ -N SRR1779721_2016_03_03_full_macs2_chipseq-16.03
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=20:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/SRR1779721_2016_03_03_full_macs2_chipseq-16.03_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/SRR1779721_2016_03_03_full_macs2_chipseq-16.03_$JOB_ID.err
#$ -j y
