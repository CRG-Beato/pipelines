#!/bin/bash
#$ -N rf_021_01_02_rnaseq_2016_06_15_full_rnaseq-16.06
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-16.06/job_out/rf_021_01_02_rnaseq_2016_06_15_full_rnaseq-16.06_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-16.06/job_out/rf_021_01_02_rnaseq_2016_06_15_full_rnaseq-16.06_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/pipelines/rnaseq-16.06/job_cmd/rf_021_01_02_rnaseq_2016_06_15_full_rnaseq-16.06.sh
time_start=$(date +"%s")
