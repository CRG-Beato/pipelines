#!/bin/bash
#$ -N fd_009_01_01_rnaseq_2016_08_26_full_rnaseq-16.06
#$ -q long-sl65
#$ -l virtual_free=50G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-16.06/job_out/fd_009_01_01_rnaseq_2016_08_26_full_rnaseq-16.06_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-16.06/job_out/fd_009_01_01_rnaseq_2016_08_26_full_rnaseq-16.06_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_08_26
...
path_job_file=/users/GR/mb/jquilez/pipelines/rnaseq-16.06/job_cmd/fd_009_01_01_rnaseq_2016_08_26_full_rnaseq-16.06.sh
time_start=$(date +"%s")
