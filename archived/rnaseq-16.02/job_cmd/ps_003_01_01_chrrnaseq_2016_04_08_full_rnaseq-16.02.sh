#!/bin/bash
#$ -N ps_003_01_01_chrrnaseq_2016_04_08_full_rnaseq-16.02
#$ -q long-sl65
#$ -l virtual_free=60G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-16.02/job_out/ps_003_01_01_chrrnaseq_2016_04_08_full_rnaseq-16.02_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-16.02/job_out/ps_003_01_01_chrrnaseq_2016_04_08_full_rnaseq-16.02_$JOB_ID.err
#$ -j y
