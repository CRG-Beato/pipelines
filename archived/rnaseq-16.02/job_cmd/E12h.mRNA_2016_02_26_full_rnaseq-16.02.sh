#!/bin/bash
#$ -N E12h.mRNA_2016_02_26_full_rnaseq-16.02
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=10:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-16.02/job_out/E12h.mRNA_2016_02_26_full_rnaseq-16.02_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-16.02/job_out/E12h.mRNA_2016_02_26_full_rnaseq-16.02_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_02_26
...
quantification_kallisto() {
	...
	n_pseudoaligned=`grep "pseudoaligned" $step_log |cut -f2 -d',' |sed "s/[^0-9]//g"`
