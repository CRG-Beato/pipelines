#!/bin/bash
#$ -N rnaseq_20151218_quantification_featurecounts_2016_01_07_test
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_quantification_featurecounts_2016_01_07_test_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_quantification_featurecounts_2016_01_07_test_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 4

submitted_on=2016_01_07
