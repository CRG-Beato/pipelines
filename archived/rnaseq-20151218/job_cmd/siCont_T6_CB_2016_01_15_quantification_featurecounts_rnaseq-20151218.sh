#!/bin/bash
#$ -N siCont_T6_CB_2016_01_15_quantification_featurecounts_rnaseq-20151218
#$ -q short-sl65
#$ -l virtual_free=1G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siCont_T6_CB_2016_01_15_quantification_featurecounts_rnaseq-20151218_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siCont_T6_CB_2016_01_15_quantification_featurecounts_rnaseq-20151218_$JOB_ID.err
#$ -j y
