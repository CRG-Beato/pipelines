#!/bin/bash
#$ -N siPADI2-R6h-R2_2016_01_18_quantification_featurecounts_rnaseq-20151218
#$ -q short-sl65
#$ -l virtual_free=1G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siPADI2-R6h-R2_2016_01_18_quantification_featurecounts_rnaseq-20151218_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siPADI2-R6h-R2_2016_01_18_quantification_featurecounts_rnaseq-20151218_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2016_01_18
pipeline_version=20151218
sample_id=siPADI2-R6h-R2
data_type=rnaseq
...
transcripts_gtf_featurecounts=$HOME/assemblies/$species/$version/gencode/gencode.v19.annotation.gtf
