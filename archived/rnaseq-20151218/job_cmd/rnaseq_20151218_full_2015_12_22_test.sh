#!/bin/bash
#$ -N rnaseq_20151218_full_2015_12_22_test
#$ -q short-sl65
#$ -l virtual_free=10G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_full_2015_12_22_test_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_full_2015_12_22_test_$JOB_ID.err
#$ -j y
#$ -V
