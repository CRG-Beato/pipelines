#!/bin/bash
#$ -N siPADI2-T0-R2_2016_01_11_quantification_kallisto_rnaseq-20151218
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siPADI2-T0-R2_2016_01_11_quantification_kallisto_rnaseq-20151218_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siPADI2-T0-R2_2016_01_11_quantification_kallisto_rnaseq-20151218_$JOB_ID.err
#$ -j y
