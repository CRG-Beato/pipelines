#!/bin/bash
#$ -N siFOXA1_T6_2_2016_01_15_quantification_featurecounts_rnaseq-20151218
#$ -q short-sl65
#$ -l virtual_free=1G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siFOXA1_T6_2_2016_01_15_quantification_featurecounts_rnaseq-20151218_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siFOXA1_T6_2_2016_01_15_quantification_featurecounts_rnaseq-20151218_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2016_01_15
pipeline_version=20151218
sample_id=siFOXA1_T6_2
data_type=rnaseq
