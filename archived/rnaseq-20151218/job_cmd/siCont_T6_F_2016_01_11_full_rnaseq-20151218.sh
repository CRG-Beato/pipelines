#!/bin/bash
#$ -N siCont_T6_F_2016_01_11_full_rnaseq-20151218
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=12:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siCont_T6_F_2016_01_11_full_rnaseq-20151218_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siCont_T6_F_2016_01_11_full_rnaseq-20151218_$JOB_ID.err
#$ -j y
