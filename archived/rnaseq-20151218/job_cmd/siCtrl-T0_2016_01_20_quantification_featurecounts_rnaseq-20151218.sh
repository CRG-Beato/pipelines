#!/bin/bash
#$ -N siCtrl-T0_2016_01_20_quantification_featurecounts_rnaseq-20151218
#$ -q short-sl65
#$ -l virtual_free=2G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siCtrl-T0_2016_01_20_quantification_featurecounts_rnaseq-20151218_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/siCtrl-T0_2016_01_20_quantification_featurecounts_rnaseq-20151218_$JOB_ID.err
#$ -j y
