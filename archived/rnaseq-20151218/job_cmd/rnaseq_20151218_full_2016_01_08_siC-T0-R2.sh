#!/bin/bash
#$ -N rnaseq_20151218_full_2016_01_08_siC-T0-R2
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_full_2016_01_08_siC-T0-R2_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_full_2016_01_08_siC-T0-R2_$JOB_ID.err
#$ -j y
