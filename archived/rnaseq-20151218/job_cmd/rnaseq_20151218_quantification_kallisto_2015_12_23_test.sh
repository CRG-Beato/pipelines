#!/bin/bash
#$ -N rnaseq_20151218_quantification_kallisto_2015_12_23_test
#$ -q short-sl65
#$ -l virtual_free=10G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_quantification_kallisto_2015_12_23_test_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20151218/job_out/rnaseq_20151218_quantification_kallisto_2015_12_23_test_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2015_12_23
...
transcripts_gtf=$HOME/assemblies/$species/$version/ucsc/${version}_ensGene.gtf.gz
...
quantification_kallisto() {
	...
	log_quantification_kallisto=$LOGS/${sample_id}_${step}_kallisto.log
...
quantification_htseq() {
	...
	# -f = input alignment is in BAM format
	# -r = alignments are sorted by genomic position
	...
	log_quantification_htseq=$LOGS/${sample_id}_${step}_htseq.log
	$htseq_count -f bam \
					-r pos \
					-s no \
