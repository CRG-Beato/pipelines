#!/bin/bash
#$ -N chipseq-peak-detection_20151112_call_peaks_2015_11_30_TE_S_T
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_call_peaks_2015_11_30_TE_S_T_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_call_peaks_2015_11_30_TE_S_T_$JOB_ID.err
#$ -j y
...
call_peaks() {
	...
	# Peak calling with SICER
		...
		if [ -f $control_bam ]; then
			...
			zerone -0 $control_bam -1 $ibam > $OUTDIR/${sample_id}_zerone.txt
