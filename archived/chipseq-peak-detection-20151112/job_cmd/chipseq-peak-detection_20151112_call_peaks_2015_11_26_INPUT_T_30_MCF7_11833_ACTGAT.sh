#!/bin/bash
#$ -N chipseq-peak-detection_20151112_call_peaks_2015_11_26_INPUT_T_30_MCF7_11833_ACTGAT
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_call_peaks_2015_11_26_INPUT_T_30_MCF7_11833_ACTGAT_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_call_peaks_2015_11_26_INPUT_T_30_MCF7_11833_ACTGAT_$JOB_ID.err
#$ -j y
