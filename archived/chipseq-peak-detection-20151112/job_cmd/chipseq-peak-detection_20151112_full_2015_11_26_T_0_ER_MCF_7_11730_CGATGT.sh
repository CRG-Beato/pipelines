#!/bin/bash
#$ -N chipseq-peak-detection_20151112_full_2015_11_26_T_0_ER_MCF_7_11730_CGATGT
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_full_2015_11_26_T_0_ER_MCF_7_11730_CGATGT_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_full_2015_11_26_T_0_ER_MCF_7_11730_CGATGT_$JOB_ID.err
#$ -j y
