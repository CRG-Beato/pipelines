#!/bin/bash
#$ -N chipseq-peak-detection_20151112_full_2015_11_17_T_30_PR_R5020_11729_GTGAAA
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_full_2015_11_17_T_30_PR_R5020_11729_GTGAAA_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_full_2015_11_17_T_30_PR_R5020_11729_GTGAAA_$JOB_ID.err
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2015_11_17
