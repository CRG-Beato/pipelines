#!/bin/bash
#$ -N chipseq-peak-detection_20151112_call_peaks_2015_11_30_T_30_PR_R5020_11729_GTGAAA
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_call_peaks_2015_11_30_T_30_PR_R5020_11729_GTGAAA_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_call_peaks_2015_11_30_T_30_PR_R5020_11729_GTGAAA_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2015_11_30
pipeline_version=20151112
sample_id=T_30_PR_R5020_11729_GTGAAA
...
slots=8
peak_caller=zerone
control_bam=$HOME/projects/er_pr/data/alignments/input_mcf7_merged_sorted_dups_removed.bam
macs2_q=0.01
...
call_peaks() {
	...
	message_info $step "Get fragment length estimate (l) as calculated in the 'make_tag_directory' step"
	fragment_length=`cat $TAG_DIR/tagInfo.txt | grep fragmentLengthEstimate |cut -f 2 -d"=" | sed 's/[^0-9]*//g'`
	message_info $step "Fragment length (l) is $fragment_length bp (note this is not used if peak caller is zerone)"
