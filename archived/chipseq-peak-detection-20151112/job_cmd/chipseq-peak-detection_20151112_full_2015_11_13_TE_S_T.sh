#!/bin/bash
#$ -N chipseq-peak-detection_20151112_full_2015_11_13_TE_S_T
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /chipseq-peak-detection_20151112_full_2015_11_13_TE_S_T_$JOB_ID.out
#$ -e /chipseq-peak-detection_20151112_full_2015_11_13_TE_S_T_$JOB_ID.err
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2015_11_13
...
target_regions=$HOME/assemblies/homo_sapiens/hg19/HDRs_20150817___REGIONS-not_DACs-DUKEs-Pickrell2011.bed
...
mapping() {
	...
	$pigz -dc -p $slots $fq \
			| $bowtie -p $slots -m 1 -k 1 --best --strata -n2 -S $index - 2>$log_mapping \
			| $samtools view -F 1804 -L $target_regions -Sb - > $obam 
