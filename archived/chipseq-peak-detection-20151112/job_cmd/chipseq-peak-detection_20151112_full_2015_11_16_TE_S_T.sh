#!/bin/bash
#$ -N chipseq-peak-detection_20151112_full_2015_11_16_TE_S_T
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /chipseq-peak-detection_20151112_full_2015_11_16_TE_S_T_$JOB_ID.out
#$ -e /chipseq-peak-detection_20151112_full_2015_11_16_TE_S_T_$JOB_ID.err
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2015_11_16
