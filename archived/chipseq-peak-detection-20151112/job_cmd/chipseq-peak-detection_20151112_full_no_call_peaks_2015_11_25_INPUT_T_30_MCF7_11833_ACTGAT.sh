#!/bin/bash
#$ -N chipseq-peak-detection_20151112_full_no_call_peaks_2015_11_25_INPUT_T_30_MCF7_11833_ACTGAT
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_full_no_call_peaks_2015_11_25_INPUT_T_30_MCF7_11833_ACTGAT_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-peak-detection-20151112/job_out/chipseq-peak-detection_20151112_full_no_call_peaks_2015_11_25_INPUT_T_30_MCF7_11833_ACTGAT_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2015_11_25
pipeline_version=20151112
sample_id=INPUT_T_30_MCF7_11833_ACTGAT
