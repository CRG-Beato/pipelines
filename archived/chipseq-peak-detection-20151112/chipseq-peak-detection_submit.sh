...
# Usage: ./chipseq-peak-detection_submit.sh
# Author: Javier Quilez (GitHub: jaquol)
# Goal: Pipeline for ChIP-seq peaks detection
#==================================================================================================
...
# Variables and paths
pipeline_name=chipseq-peak-detection
...
if ! [[ -n "$config" ]]; then
	...
	samples=`cat $config | grep '=' | grep samples | cut -f2 -d"="`
...
for s in $samples; do
	...
	job_name=${pipeline_name}_${pipeline_version}_${pipeline_run_mode}_${submitted_on}_${s}
