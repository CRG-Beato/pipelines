#!/bin/bash
#$ -N rf_017_01_02_rnaseq_2016_06_06_full_rnaseq-16.04
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-16.04/job_out/rf_017_01_02_rnaseq_2016_06_06_full_rnaseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-16.04/job_out/rf_017_01_02_rnaseq_2016_06_06_full_rnaseq-16.04_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/pipelines/rnaseq-16.04/job_cmd/rf_017_01_02_rnaseq_2016_06_06_full_rnaseq-16.04.sh
time_start=$(date +"%s")
