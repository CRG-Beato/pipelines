#!/bin/bash
#$ -N T0_F_2016_02_19_full_chipseq-16.02
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=20:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.02/job_out/T0_F_2016_02_19_full_chipseq-16.02_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.02/job_out/T0_F_2016_02_19_full_chipseq-16.02_$JOB_ID.err
#$ -j y
