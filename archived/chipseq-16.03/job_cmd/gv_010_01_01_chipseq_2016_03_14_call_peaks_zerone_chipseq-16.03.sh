#!/bin/bash
#$ -N gv_010_01_01_chipseq_2016_03_14_call_peaks_zerone_chipseq-16.03
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=20:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/gv_010_01_01_chipseq_2016_03_14_call_peaks_zerone_chipseq-16.03_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.03/job_out/gv_010_01_01_chipseq_2016_03_14_call_peaks_zerone_chipseq-16.03_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.03/job_cmd/gv_010_01_01_chipseq_2016_03_14_call_peaks_zerone_chipseq-16.03.sh
time_start=$(date +"%s")
