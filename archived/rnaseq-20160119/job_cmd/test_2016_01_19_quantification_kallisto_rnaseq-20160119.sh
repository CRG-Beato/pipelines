#!/bin/bash
#$ -N test_2016_01_19_quantification_kallisto_rnaseq-20160119
#$ -q short-sl65
#$ -l virtual_free=1G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/test_2016_01_19_quantification_kallisto_rnaseq-20160119_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/test_2016_01_19_quantification_kallisto_rnaseq-20160119_$JOB_ID.err
#$ -j y
...
sample_id=test
data_type=rnaseq
pipeline_run_mode=quantification_kallisto
io_mode=standard
...
quantification_kallisto() {
	...
	message_info $step "using $transcripts_gtf as transcriptome reference"
...
quantification_featurecounts() {
	...
	$featureCounts $add_param \
					...
					-s $strand_specific \
					-T $slots \
					-a $transcripts_gtf_featurecounts \
					-o $ofile \
