#!/bin/bash
#$ -N test_2016_01_19_map_star_rnaseq-20160119
#$ -q short-sl65
#$ -l virtual_free=1G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/test_2016_01_19_map_star_rnaseq-20160119_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/test_2016_01_19_map_star_rnaseq-20160119_$JOB_ID.err
#$ -j y
