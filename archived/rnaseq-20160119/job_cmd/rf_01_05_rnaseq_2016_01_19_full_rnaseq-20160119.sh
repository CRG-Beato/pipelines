#!/bin/bash
#$ -N rf_01_05_rnaseq_2016_01_19_full_rnaseq-20160119
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/rf_01_05_rnaseq_2016_01_19_full_rnaseq-20160119_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/rf_01_05_rnaseq_2016_01_19_full_rnaseq-20160119_$JOB_ID.err
#$ -j y
