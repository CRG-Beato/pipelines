#!/bin/bash
#$ -N fd_004_01_01_rnaseq_2016_02_09_full_rnaseq-20160119
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=10:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/fd_004_01_01_rnaseq_2016_02_09_full_rnaseq-20160119_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/fd_004_01_01_rnaseq_2016_02_09_full_rnaseq-20160119_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_02_09
pipeline_version=20160119
sample_id=fd_004_01_01_rnaseq
data_type=rnaseq
...
chrom_sizes=/users/GR/mb/jquilez/assemblies/$species/$version/ucsc/$version.chrom.sizes.autosomes.chrX
if [[ $version == "hg19" ]]; then
	kallisto_index=/users/GR/mb/jquilez/assemblies/$species/$version/kallisto_index/kallisto_${species}_${version}_ensGene.index
	transcripts_gtf=/users/GR/mb/jquilez/assemblies/$species/$version/gencode/gencode.v19.annotation.gtf
elif [[ $version == "hg38" ]]; then
	kallisto_index=/users/GR/mb/jquilez/assemblies/$species/$version/kallisto_index/kallisto_${species}_${version}_gencode_v24.index
	transcripts_gtf=/users/GR/mb/jquilez/assemblies/$species/$version/gencode/gencode.v24.annotation.gtf
fi
