#!/bin/bash
#$ -N test_2016_01_19_make_profiles_rnaseq-20160119
#$ -q short-sl65
#$ -l virtual_free=1G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/test_2016_01_19_make_profiles_rnaseq-20160119_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-20160119/job_out/test_2016_01_19_make_profiles_rnaseq-20160119_$JOB_ID.err
#$ -j y
...
if [[ $version == "hg19" ]]; then
	index=$HOME/assemblies/$species/$version/kallisto_index/kallisto_${species}_${version}_ensGene.index
	transcripts_gtf=$HOME/assemblies/$species/$version/gencode/gencode.v19.annotation.gtf
elif [[ $version == "hg38" ]]; then
	index=$HOME/assemblies/$species/$version/kallisto_index/kallisto_${species}_${version}_gencode_v24.index
