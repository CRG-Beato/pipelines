#!/bin/bash
#$ -N ps_004_01_01_chrrnaseq_2016_04_21_full_rnaseq-16.04
#$ -q long-sl65
#$ -l virtual_free=60G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-16.04/job_out/ps_004_01_01_chrrnaseq_2016_04_21_full_rnaseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-16.04/job_out/ps_004_01_01_chrrnaseq_2016_04_21_full_rnaseq-16.04_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/pipelines/rnaseq-16.04/job_cmd/ps_004_01_01_chrrnaseq_2016_04_21_full_rnaseq-16.04.sh
time_start=$(date +"%s")
