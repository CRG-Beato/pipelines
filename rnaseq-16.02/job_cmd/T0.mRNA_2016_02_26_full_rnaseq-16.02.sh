#!/bin/bash
#$ -N T0.mRNA_2016_02_26_full_rnaseq-16.02
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=10:00:00
#$ -o /users/GR/mb/jquilez/pipelines/rnaseq-16.02/job_out/T0.mRNA_2016_02_26_full_rnaseq-16.02_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/rnaseq-16.02/job_out/T0.mRNA_2016_02_26_full_rnaseq-16.02_$JOB_ID.err
#$ -j y
