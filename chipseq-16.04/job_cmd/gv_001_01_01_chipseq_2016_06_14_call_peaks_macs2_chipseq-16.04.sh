#!/bin/bash
#$ -N gv_001_01_01_chipseq_2016_06_14_call_peaks_macs2_chipseq-16.04
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_001_01_01_chipseq_2016_06_14_call_peaks_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_001_01_01_chipseq_2016_06_14_call_peaks_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/gv_001_01_01_chipseq_2016_06_14_call_peaks_macs2_chipseq-16.04.sh
