#!/bin/bash
#$ -N gv_073_01_01_atacseq_2016_08_24_full_macs2_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_073_01_01_atacseq_2016_08_24_full_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_073_01_01_atacseq_2016_08_24_full_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_08_24
pipeline_version=16.04
sample_id=gv_073_01_01_atacseq
data_type=atacseq
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/gv_073_01_01_atacseq_2016_08_24_full_macs2_chipseq-16.04.sh
