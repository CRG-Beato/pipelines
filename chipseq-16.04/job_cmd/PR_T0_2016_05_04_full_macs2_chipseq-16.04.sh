#!/bin/bash
#$ -N PR_T0_2016_05_04_full_macs2_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=60G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/PR_T0_2016_05_04_full_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/PR_T0_2016_05_04_full_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_05_04
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/PR_T0_2016_05_04_full_macs2_chipseq-16.04.sh
