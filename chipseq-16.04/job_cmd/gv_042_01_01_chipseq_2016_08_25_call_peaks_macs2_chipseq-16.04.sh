#!/bin/bash
#$ -N gv_042_01_01_chipseq_2016_08_25_call_peaks_macs2_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_042_01_01_chipseq_2016_08_25_call_peaks_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_042_01_01_chipseq_2016_08_25_call_peaks_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
...
sample_id=gv_042_01_01_chipseq
data_type=chipseq
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/gv_042_01_01_chipseq_2016_08_25_call_peaks_macs2_chipseq-16.04.sh
