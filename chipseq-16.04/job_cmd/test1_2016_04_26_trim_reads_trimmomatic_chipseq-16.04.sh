#!/bin/bash
#$ -N test1_2016_04_26_trim_reads_trimmomatic_chipseq-16.04
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/test1_2016_04_26_trim_reads_trimmomatic_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/test1_2016_04_26_trim_reads_trimmomatic_chipseq-16.04_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/test1_2016_04_26_trim_reads_trimmomatic_chipseq-16.04.sh
time_start=$(date +"%s")
