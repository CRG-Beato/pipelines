#!/bin/bash
#$ -N rf_010_01_01_chipseq_2016_05_29_full_macs2_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=50G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/rf_010_01_01_chipseq_2016_05_29_full_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/rf_010_01_01_chipseq_2016_05_29_full_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_05_29
pipeline_version=16.04
sample_id=rf_010_01_01_chipseq
data_type=chipseq
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/rf_010_01_01_chipseq_2016_05_29_full_macs2_chipseq-16.04.sh
