#!/bin/bash
#$ -N ps_014_01_01_chipseq_2016_09_27_full_macs2_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/ps_014_01_01_chipseq_2016_09_27_full_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/ps_014_01_01_chipseq_2016_09_27_full_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2016_09_27
pipeline_version=16.04
sample_id=ps_014_01_01_chipseq
data_type=chipseq
pipeline_name=chipseq
pipeline_version=16.04
pipeline_run_mode=full
io_mode=standard
CUSTOM_IN=/users/GR/mb/jquilez/data/chipseq/raw/2015-11-12
...
use_control=yes
macs2_qvalue=0.05
control_bam=/users/GR/mb/jquilez/data/chipseq/samples/T0_roberto_input/alignments/bwa/hg19/single_end/T0_roberto_input_sorted_unique.bam
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/ps_014_01_01_chipseq_2016_09_27_full_macs2_chipseq-16.04.sh
