#!/bin/bash
#$ -N gv_009_02_01_chipseq_2016_05_18_call_peaks_macs2_chipseq-16.04
#$ -q short-sl65
#$ -l virtual_free=10G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_009_02_01_chipseq_2016_05_18_call_peaks_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_009_02_01_chipseq_2016_05_18_call_peaks_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 2

submitted_on=2016_05_18
pipeline_version=16.04
sample_id=gv_009_02_01_chipseq
data_type=chipseq
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/gv_009_02_01_chipseq_2016_05_18_call_peaks_macs2_chipseq-16.04.sh
