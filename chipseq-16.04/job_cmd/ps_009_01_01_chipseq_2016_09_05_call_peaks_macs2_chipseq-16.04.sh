#!/bin/bash
#$ -N ps_009_01_01_chipseq_2016_09_05_call_peaks_macs2_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/ps_009_01_01_chipseq_2016_09_05_call_peaks_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/ps_009_01_01_chipseq_2016_09_05_call_peaks_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_09_05
pipeline_version=16.04
sample_id=ps_009_01_01_chipseq
data_type=chipseq
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/ps_009_01_01_chipseq_2016_09_05_call_peaks_macs2_chipseq-16.04.sh
