#!/bin/bash
#$ -N gv_041_01_01_chipseq_2016_04_27_full_macs2_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=60G
#$ -l h_rt=20:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_041_01_01_chipseq_2016_04_27_full_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_041_01_01_chipseq_2016_04_27_full_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_04_27
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/gv_041_01_01_chipseq_2016_04_27_full_macs2_chipseq-16.04.sh
