#!/bin/bash
#$ -N gv_068_01_01_chipseq_2016_04_28_call_peaks_macs2_chipseq-16.04
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=06:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_068_01_01_chipseq_2016_04_28_call_peaks_macs2_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/gv_068_01_01_chipseq_2016_04_28_call_peaks_macs2_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2016_04_28
pipeline_version=16.04
sample_id=gv_068_01_01_chipseq
data_type=chipseq
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/gv_068_01_01_chipseq_2016_04_28_call_peaks_macs2_chipseq-16.04.sh
