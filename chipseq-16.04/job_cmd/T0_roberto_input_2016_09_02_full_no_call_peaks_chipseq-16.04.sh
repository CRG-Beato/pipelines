#!/bin/bash
#$ -N T0_roberto_input_2016_09_02_full_no_call_peaks_chipseq-16.04
#$ -q long-sl65
#$ -l virtual_free=40G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/T0_roberto_input_2016_09_02_full_no_call_peaks_chipseq-16.04_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/pipelines/chipseq-16.04/job_out/T0_roberto_input_2016_09_02_full_no_call_peaks_chipseq-16.04_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2016_09_02
pipeline_version=16.04
sample_id=T0_roberto_input
data_type=chipseq
pipeline_name=chipseq
pipeline_version=16.04
pipeline_run_mode=full_no_call_peaks
io_mode=standard
...
use_control=yes
macs2_qvalue=0.05
control_bam=/users/GR/mb/jquilez/data/chipseq/samples/T0_roberto_input/alignments/bwa/hg38_mmtv/single_end/T0_roberto_input_sorted_unique.bam
...
path_job_file=/users/GR/mb/jquilez/pipelines/chipseq-16.04/job_cmd/T0_roberto_input_2016_09_02_full_no_call_peaks_chipseq-16.04.sh
